...
public class GetProfileClient {
    ...
    @SerializedName("city")
    @Expose
    private GetProfileCity city;
    @SerializedName("blood_type")
    @Expose
    private GetProfileBloodType bloodType;
    ...
    public GetProfileCity getCity() {
        return city;
    }

    public void setCity(GetProfileCity city) {
        this.city = city;
    }

    public GetProfileBloodType getBloodType() {
        return bloodType;
    }

    public void setBloodType(GetProfileBloodType getProfileBloodType) {
        this.bloodType = getProfileBloodType;
    }
