...
public class DatumListNotification {
    ...
    @Expose
    private PivotListNotification pivot;
    ...
    public PivotListNotification getPivot() {
        return pivot;
    }

    public void setPivot(PivotListNotification pivot) {
        this.pivot = pivot;
    }
