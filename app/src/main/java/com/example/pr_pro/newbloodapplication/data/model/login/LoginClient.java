...
package com.example.pr_pro.newbloodapplication.data.model.login;
...
public class LoginClient {
    ...
    @SerializedName("city")
    @Expose
    private LoginCity city;
    @SerializedName("blood_type")
    @Expose
    private LoginBloodType bloodType;
    ...
    public LoginCity getCity() {
        return city;
    }

    public void setCity(LoginCity city) {
        this.city = city;
    }

    public LoginBloodType getBloodType() {
        return bloodType;
    }

    public void setBloodType(LoginBloodType bloodType) {
